            ...
            <Grid item xs={12} sm={6} key={feature.key}>
              ...
              >
                ...
                <Switch
                  size="small"
                  disabled={!enabled}
                  checked={enabled && (config[category] as any)[feature.key]}
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} lg={6}>
            {renderFeatureCard(
              ...
              [
                ...
                { key: 'voiceCloning', label: '声音克隆', premium: true },
                { key: 'realtimeConversation', label: '实时语音对话', premium: true }
              ],
          ...
          <Grid item xs={12} lg={6}>
            {renderFeatureCard(
              ...
              [
                ...
                { key: 'videoProcessing', label: '视频处理', premium: true },
                { key: 'documentScanning', label: '文档扫描' },
          ...
          <Grid item xs={12} lg={6}>
            {renderFeatureCard(
              ...
              'advancedFeatures',
              [
                { key: 'webBrowsing', label: '网络浏览' },
                { key: 'apiIntegration', label: 'API集成' },
                { key: 'codeExecution', label: '代码执行', premium: true },
                { key: 'dataVisualization', label: '数据可视化' },
                { key: 'workflowAutomation', label: '工作流自动化', premium: true },
                { key: 'knowledgeGraphing', label: '知识图谱', premium: true }
              ],
              theme.palette.error.main,
              config.advancedFeatures.webBrowsing || 
              config.advancedFeatures.apiIntegration || 
              config.advancedFeatures.codeExecution ||
              config.advancedFeatures.dataVisualization ||
              config.advancedFeatures.workflowAutomation ||
              config.advancedFeatures.knowledgeGraphing
            )}
          </Grid>
        </Grid>
