...
import { ChevronDown, Settings, Database, FileText, Info, FileSearch, Globe, BookOpen, Server, Plug, GitBranch } from 'lucide-react';
        ...
        <div style={sectionStyle}>
          ...
          <div style={toggleContainerStyle}>
            ...
            <label style={toggleStyle}>
              ...
              />
              <span style={toggleSliderStyle(toggleStates.visibility)} />
            </label>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={toggleContainerStyle}>
            ...
            <label style={toggleStyle}>
              ...
              />
              <span style={toggleSliderStyle(toggleStates.knowledgeBase)} />
            </label>
          </div>
          ...
          <div style={toggleContainerStyle}>
            ...
            <label style={toggleStyle}>
              ...
              />
              <span style={toggleSliderStyle(toggleStates.documentParsing)} />
            </label>
          </div>
          ...
          <div style={toggleContainerStyle}>
            ...
            <label style={toggleStyle}>
              ...
              />
              <span style={toggleSliderStyle(toggleStates.webSearch)} />
            </label>
          </div>
          ...
          <div style={toggleContainerStyle}>
            ...
            <label style={toggleStyle}>
              ...
              />
              <span style={toggleSliderStyle(toggleStates.examples)} />
            </label>
          </div>
        </div>
