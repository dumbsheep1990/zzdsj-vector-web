...
export const advancedTools: Tool[] = [
  ...
  },
  {
    ...
    category: ToolCategory.SEARCH,
    icon: <ExperimentOutlined style={{ fontSize: '18px', color: '#722ed1' }} />,
  ...
  },
  {
    ...
    category: ToolCategory.RETRIEVAL,
    icon: <PlayCircleOutlined style={{ fontSize: '18px', color: '#fa8c16' }} />,
  ...
  // 推理工具类别
  {
    ...
    icon: <BulbOutlined style={{ fontSize: '18px', color: '#eb2f96' }} />,
  ...
  // 集成工具类别
  {
    ...
    icon: <LinkOutlined style={{ fontSize: '18px', color: '#f5222d' }} />,
