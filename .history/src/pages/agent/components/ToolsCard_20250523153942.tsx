  ...
  ({ theme, isSelected, category }) => {
    ...
    const getCategoryColors = () => {
      switch(category) {
        case 'search':
          return {
            light: alpha(theme.palette.info.light, 0.25),
            medium: alpha(theme.palette.info.main, 0.15),
            accent: theme.palette.info.main
          };
        case 'retrieval':
          return {
            light: alpha(theme.palette.primary.light, 0.25),
            medium: alpha(theme.palette.primary.main, 0.15),
            accent: theme.palette.primary.main
          };
        case 'reasoning':
          return {
            light: alpha(theme.palette.secondary.light, 0.25),
            medium: alpha(theme.palette.secondary.main, 0.15),
            accent: theme.palette.secondary.main
          };
        case 'knowledge':
          return {
            light: alpha('#22c55e', 0.25), // 绿色
            medium: alpha('#22c55e', 0.15),
            accent: '#22c55e'
          };
        case 'integration':
          return {
            light: alpha('#f59e0b', 0.25), // 橙色
            medium: alpha('#f59e0b', 0.15),
            accent: '#f59e0b'
          };
        case 'development':
          return {
            light: alpha('#7c3aed', 0.25), // 紫色
            medium: alpha('#7c3aed', 0.15), 
            accent: '#7c3aed'
          };
        case 'multimodal':
          return {
            light: alpha('#ec4899', 0.25), // 粉色
            medium: alpha('#ec4899', 0.15),
            accent: '#ec4899'
          };
        default:
          return {
            light: alpha(theme.palette.grey[500], 0.25),
            medium: alpha(theme.palette.grey[500], 0.15),
