...
interface VectorsListSkeletonProps {
  rowCount?: number;
}

const VectorsListSkeleton: React.FC<VectorsListSkeletonProps> = ({ rowCount = 5 }) => {
  return (
        ...
        <tbody className="bg-white divide-y divide-gray-100">
          {Array(rowCount).fill(0).map((_, index) => (
            <tr key={index} className="group transition-all duration-200">
              <td className="px-6 py-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="skeleton-pulse h-3 w-24 rounded"></div>
                  </div>
                </div>
              </td>
              <td className="px-6 py-4">
              ...
              <td className="px-6 py-4">
                <div className="skeleton-pulse h-5 w-16 rounded-md"></div>
              </td>
              <td className="px-6 py-4">
...
export default VectorsListSkeleton;
