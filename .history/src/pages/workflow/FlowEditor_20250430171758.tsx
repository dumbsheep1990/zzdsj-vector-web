...
// 导入类型和模拟数据
import { FlowEditorProps, Workflow, WorkflowFormValues, FormValues, ToolsRef } from './types';
import { initialNodes, initialEdges, mockAgents, mockTools, mockApplications } from './mockData';
