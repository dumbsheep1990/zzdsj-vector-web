...
const Sidebar: React.FC = () => {
    ...
    // Force a value to be a boolean, no matter what
    ...
    const renderNavItem = useCallback((item: NavigationItem, isChild: boolean = false, index: number = 0) => {
        ...
        // Remove the type assertion and use our helper function
        const currentStyle = {
            ...getNavItemStyle(isActive, toBoolean(isChild), toBoolean(hasChildren)),
                ...
                >
                    <span style={iconContainerStyle}>
                        <span style={{ display: 'flex', alignItems: 'center' }}>
                            <span style={getIconStyle(isActive, toBoolean(isChild), toBoolean(hasChildren))}>
