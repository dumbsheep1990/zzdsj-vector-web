...
import { Button, Card, Input, Select, Typography, Drawer, Form, message, Modal, Table, Tag, Input as AntInput } from 'antd';
...
const TaskOrchestrationPage: React.FC = () => {
  ...
  const [availableTools, setAvailableTools] = useState<ToolConfig[]>(mockTools);
