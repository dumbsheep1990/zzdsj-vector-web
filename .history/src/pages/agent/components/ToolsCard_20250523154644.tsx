  ...
  ({ theme, isSelected, category }) => {
    ...
    const getCategoryColors = () => {
      switch(category) {
        case 'search':
          return {
            bgColor: 'rgba(24, 144, 255, 0.6)', // 蓝色 - 更高透明度
            accent: '#1890ff'
          };
        case 'retrieval':
          return {
            bgColor: 'rgba(22, 119, 255, 0.6)', // 深蓝色 - 更高透明度
            accent: '#1677ff'
          };
        case 'reasoning':
          return {
            bgColor: 'rgba(114, 46, 209, 0.6)', // 紫色 - 更高透明度
            accent: '#722ed1'
          };
        case 'knowledge':
          return {
            bgColor: 'rgba(34, 197, 94, 0.6)', // 绿色 - 更高透明度
            accent: '#22c55e'
          };
        case 'integration':
          return {
            bgColor: 'rgba(245, 158, 11, 0.6)', // 橙色 - 更高透明度
            accent: '#f59e0b'
          };
        case 'development':
          return {
            bgColor: 'rgba(124, 58, 237, 0.6)', // 紫色 - 更高透明度
            accent: '#7c3aed'
          };
        case 'multimodal':
          return {
            bgColor: 'rgba(236, 72, 153, 0.6)', // 粉色 - 更高透明度
            accent: '#ec4899'
          };
        default:
          return {
            bgColor: 'rgba(100, 116, 139, 0.5)', // 默认 - 更高透明度
            accent: '#64748b'
          };
      }
    };
