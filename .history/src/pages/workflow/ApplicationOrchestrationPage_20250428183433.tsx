...
const ApplicationOrchestrationPage: React.FC = () => {
  ...
  const deleteCustomVariable = (id: string) => {
    console.log('Deleting variable with id:', id);
    setCustomVariables(prevVariables => {
      const updatedVariables = prevVariables.filter(variable => variable.id !== id);
      ...
      <div style={leftPanelStyle}>
        ...
        <div style={sectionStyle}>
          ...
          {expandedSections.variables && (
            <>
              {/* Display custom variables if any exist */}
                    ...
                    >
                      ...
                      <button 
                        style={{ 
                          ...
                          alignItems: 'center',
                          padding: '4px',
                          zIndex: 5 // Ensure higher z-index
                        }}
                        onClick={(e) => {
