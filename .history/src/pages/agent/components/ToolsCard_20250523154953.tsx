  ...
  ({ theme, isSelected, category }) => {
    ...
    const getCategoryColors = () => {
      switch(category) {
        case 'search':
          return {
            bgColor: 'rgba(24, 144, 255, 0.8)', // 蓝色 - 更高透明度
            accent: '#1890ff'
          };
        case 'retrieval':
          return {
            bgColor: 'rgba(22, 119, 255, 0.8)', // 深蓝色 - 更高透明度
            accent: '#1677ff'
          };
        case 'reasoning':
          return {
            bgColor: 'rgba(114, 46, 209, 0.8)', // 紫色 - 更高透明度
            accent: '#722ed1'
          };
        case 'knowledge':
          return {
            bgColor: 'rgba(34, 197, 94, 0.8)', // 绿色 - 更高透明度
            accent: '#22c55e'
          };
        case 'integration':
          return {
            bgColor: 'rgba(245, 158, 11, 0.8)', // 橙色 - 更高透明度
            accent: '#f59e0b'
          };
        case 'development':
          return {
            bgColor: 'rgba(124, 58, 237, 0.8)', // 紫色 - 更高透明度
            accent: '#7c3aed'
          };
        case 'multimodal':
          return {
            bgColor: 'rgba(236, 72, 153, 0.8)', // 粉色 - 更高透明度
            accent: '#ec4899'
          };
        default:
          return {
            bgColor: 'rgba(100, 116, 139, 0.7)', // 默认 - 更高透明度
            accent: '#64748b'
          };
      }
    };
    ...
    return {
      ...
      position: 'relative',
      overflow: 'hidden',
      backgroundColor: `${colors.bgColor} !important`, // 强制应用背景色
      background: `${colors.bgColor} !important`,  // 强制应用背景色
