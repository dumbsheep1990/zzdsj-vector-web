  ...
  ({ theme, isSelected, category }) => {
    ...
    const getCategoryColors = () => {
      switch(category) {
        case 'search':
          return {
            bgColor: 'rgba(24, 144, 255, 0.18)', // 蓝色
            accent: '#1890ff'
          };
        case 'retrieval':
          return {
            bgColor: 'rgba(22, 119, 255, 0.18)', // 深蓝色
            accent: '#1677ff'
          };
        case 'reasoning':
          return {
            bgColor: 'rgba(114, 46, 209, 0.18)', // 紫色
            accent: '#722ed1'
          };
        case 'knowledge':
          return {
            bgColor: 'rgba(34, 197, 94, 0.18)', // 绿色
            accent: '#22c55e'
          };
        case 'integration':
          return {
            bgColor: 'rgba(245, 158, 11, 0.18)', // 橙色
            accent: '#f59e0b'
          };
        case 'development':
          return {
            bgColor: 'rgba(124, 58, 237, 0.18)', // 紫色
            accent: '#7c3aed'
          };
        case 'multimodal':
          return {
            bgColor: 'rgba(236, 72, 153, 0.18)', // 粉色
            accent: '#ec4899'
          };
        default:
          return {
