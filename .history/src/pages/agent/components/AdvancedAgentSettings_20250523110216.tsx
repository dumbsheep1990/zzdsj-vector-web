...
const AdvancedAgentSettings: React.FC<AdvancedAgentSettingsProps> = ({
  ...
  // 处理滑块变化
  const handleSliderChange = (key: keyof AdvancedAgentSettings) => (_: Event, newValue: number | number[]) => {
            ...
            <Box sx={{ 
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                <Typography variant="caption" sx={{ 
                  fontWeight: 600,
                  color: settings.autonomousToolCalling ? theme.palette.primary.main : theme.palette.text.secondary
                }}>
                  自主调用
                </Typography>
                <Switch
