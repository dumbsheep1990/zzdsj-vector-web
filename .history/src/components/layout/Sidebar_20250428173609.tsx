...
const Sidebar: React.FC = () => {
    ...
    const renderNavItem = useCallback((item: NavigationItem, isChild: boolean = false, index: number = 0) => {
        ...
        const getNavItemStyleAny = getNavItemStyle as any;
        const getIconStyleAny = getIconStyle as any;

        const currentStyle = {
            ...getNavItemStyleAny(isActive, isChild, hasChildren),
                ...
                >
                    <span style={iconContainerStyle}>
                        <span style={{ display: 'flex', alignItems: 'center' }}>
                            <span style={getIconStyleAny(isActive, isChild, hasChildren)}>
